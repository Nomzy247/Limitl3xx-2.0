        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-3">
              <button onClick={() => navigate('/buy-hashpower')} className="w-full p-3 rounded-xl bg-surface hover:bg-subtle border border-border/50 transition-all text-left flex items-center justify-between group">
              ...
              <button onClick={() => navigate('/transactions')} className="w-full p-3 rounded-xl bg-surface hover:bg-subtle border border-border/50 transition-all text-left flex items-center justify-between group">
                <span className="text-sm font-medium">View History</span>
                <ArrowUpRight size={16} className="text-muted group-hover:text-primary transition-colors" />
              </button>
              <button onClick={() => navigate('/support')} className="w-full p-3 rounded-xl bg-surface hover:bg-subtle border border-border/50 transition-all text-left flex items-center justify-between group">
